...
* 2 [风格规范](#2-风格规范)
   * 2.1 [文件](#21-文件)
     * 2.1.1 [Shebang](#211-Shebang)
     * 2.1.2 [文件和sockets管理](#212-文件和sockets管理)
   * 2.2 [结构](#22-结构)
     * 2.2.1 [分号](#221-分号)
     * 2.2.2 [行长度](#222-行长度)
     * 2.2.3 [括号](#223-括号)
   ...
   * 2.3 [注释](#23-注释)
     * 2.3.1 [注释方式](#231-注释方式)
     * 2.3.2 [模块注释](#232-模块注释)
     * 2.3.3 [函数/方法注释](#233-函数/方法注释)
     * 2.3.4 [类注释](#234-类注释)
     * 2.3.5 [块注释和行注释](#235-块注释和行注释)
     * 2.3.6 [TODO注释](#236-TODO注释)
   * 2.4 [导入格式](#24-导入格式)
   * 2.5 [命名](#25-命名)
   * 2.6 [其他](#26-其他)
     * 2.6.1 [语句](#261-语句)
...
* 3 [语言规范](#3-语言规范)
   ...
   * 3.3 [列表推导](#33-列表推导)
   * 3.4 [条件表达式](#34-条件表达式)
   * 3.5 [True/False的求值](#35-True/False的求值)
   * 3.6 [默认迭代器和操作符](#36-默认迭代器和操作符)
   * 3.7 [生成器](#37-生成器)
   * 3.8 [类或函数](#38-类或函数)
     * 3.8.1 [嵌套/局部/内部类或函数](#381-嵌套/局部/内部类或函数)
     * 3.8.2 [Lambda](#382-Lambda)
     * 3.8.3 [函数与方法装饰器](#383-函数与方法装饰器)
   * 3.9 [线程](#39-线程)
   * 3.10 [异常](#310-异常)
